...
const  FacultyLogin = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/api/Faculty/loginfaculty", formData);
...
// </a>
        ...
        // window.open("/facultyProfile", "_blank");
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-2 top-9 text-gray-600 hover:text-gray-200"
            >
